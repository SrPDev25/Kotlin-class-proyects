...
class ListenerAdapterCategorias(private val categorias: List<Categoria>, private val cont: Context, private val listener: Events) :
    RecyclerView.Adapter<ListenerAdapterCategorias.ViewHolder>() {
